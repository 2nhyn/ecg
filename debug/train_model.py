...
# python /Data/nh25/ECG/nh_submission2/train_model.py -d /Data/physionet2025/full_train -m model -v
 # python /Data/nh25/ECG/nh_submission2/train_model.py -d /Data/nh25/ECG/data -m model -v
