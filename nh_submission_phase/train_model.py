...
# python /Data/nh25/ECG/nh_submission3/train_model.py -d /Data/physionet2025/full_train -m model -v
# python /Data/nh25/ECG/nh_submission_phase/train_model.py -d /Data/nh25/ECG/0_Data/processed_full_train_data -m /Data/nh25/ECG/nh_submission_phase/models -v
# python /Data/nh25/ECG/nh_submission3/train_model.py -d /Data/nh25/ECG/0_Data/processed_full_train_data -m model_simple_data_processed -v
